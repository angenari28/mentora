...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mentora.Domain.Entities.Class", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CourseId = new Guid("b1c2d3e4-f5a6-7890-bcde-f12345678901"),
                            CreatedAt = new DateTime(2026, 1, 23, 0, 0, 0, 0, DateTimeKind.Utc),
                            DateEnd = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            DateStart = new DateTime(2026, 4, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "Tecnologia",
                            UpdatedAt = new DateTime(2026, 1, 23, 0, 0, 0, 0, DateTimeKind.Utc),
                            WorkspaceId = new Guid("0097e236-eb5d-4858-9f23-4522833c865c")
                        });
            ...
            modelBuilder.Entity("Mentora.Domain.Entities.ClassStudent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            ClassId = new Guid("d1e2f3a4-b5c6-7890-def0-123456789001"),
                            CreatedAt = new DateTime(2026, 1, 23, 0, 0, 0, 0, DateTimeKind.Utc),
                            UpdatedAt = new DateTime(2026, 1, 23, 0, 0, 0, 0, DateTimeKind.Utc),
                            UserId = new Guid("e1f2a3b4-c5d6-7890-ef01-234567890001")
                        });
                });
            ...
            modelBuilder.Entity("Mentora.Domain.Entities.CourseSlide", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 23, 0, 0, 0, 0, DateTimeKind.Utc),
                            Ordering = 1,
                            SlideTypeId = new Guid("a1b2c3d4-0001-0000-0000-000000000001"),
            ...
            modelBuilder.Entity("Mentora.Domain.Entities.CourseSlideTime", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("CourseSlideId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CourseSlideId");

                    b.ToTable("CourseSlidesTimes", (string)null);
                });
            ...
            modelBuilder.Entity("Mentora.Domain.Entities.CourseSlideTime", b =>
                {
                    b.HasOne("Mentora.Domain.Entities.CourseSlide", "CourseSlide")
                        .WithMany()
                        .HasForeignKey("CourseSlideId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CourseSlide");
                });
